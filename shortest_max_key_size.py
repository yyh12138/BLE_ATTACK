    ...
    if data:
        ...
        if pkt is None:
            ...
            ### BTLE/DATA/L2CAP/SM/ ###
                ...
                print(Fore.YELLOW + "Slave accepts the max key size is: " + str(current_max_key_size))
                if current_max_key_size<=6:
                    print(Fore.RED + "Slave allows the max key size lower than 7!")
                elif current_max_key_size>6 and current_max_key_size <=15:
                    print(Fore.RED + "Slave allows the max key size reduction.")
                break
            ...
            ### BTLE/DATA/L2CAP/ATT/ ###
                ...
                pairing_req = BTLE(access_addr=blueShiro.access_addr) / BTLE_DATA(SN=blueShiro.sn, NESN=blueShiro.nesn) / L2CAP_Hdr() / SM_Hdr() / SM_Pairing_Request(
                    ...
                    max_key_size=current_max_key_size,
